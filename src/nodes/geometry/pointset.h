#ifndef __POINTSET_H3D
#define __POINTSET_H3D
//-------------------------------------------------------------------------
...
CLASS
	...
	This class corresponds to the PointSet node in VRML.  
	<A href="../spec/part1/nodesRef.html#PointSet">Further information</a> 
	about this class is available in any VRML related documentation.

DESCRIPTION
	<ul>This node corresponds to the PointSet node as defined in the VRML97 
	specification.  Like all Node Classes this class is better described in the 
	<A href="../spec/index.html">VRML97 Specification</a>.  In particular, at this 
	<A href="../spec/part1/nodesRef.html#PointSet">link</a>.</ul>
...
MEMBERS
----------------------------------------------------------------------*/
class LIBInterface vrPointSet : public vrDataSet
{
protected:
...
public:
	...
	// <dd>Copy constructor.
	//
	vrPointSet(const vrPointSet& v);

	//<doc>------------------------------------------------------------
	// <dd>Destructor.
	//
	virtual ~vrPointSet(void);

	//<doc>------------------------------------------------------------
	// <dd>Equals operator.
	//
	vrPointSet& operator=(const vrPointSet& v);
...
//----------------------------------------------------------------------
inline void vrPointSet::Traverse(vrTraverser *t) const
{
	t->Traverse(this);
}
#endif
