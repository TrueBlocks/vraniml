...
CLASS
	...
	This class corresponds to the Cone node in VRML.  
	<A href="../spec/part1/nodesRef.html#Cone">Further information</a> 
	about this class is available in any VRML related documentation.

DESCRIPTION
	<ul>This node corresponds to the Cone node as defined in the VRML97 
	specification.  Like all Node Classes this class is better described in the 
	<A href="../spec/index.html">VRML97 Specification</a>.  In particular, at this 
	<A href="../spec/part1/nodesRef.html#Cone">link</a>.</ul>
...
MEMBERS
----------------------------------------------------------------------*/
class LIBInterface vrCone : public vrGeometryNode
{
protected:
	//<doc>------------------------------------------------------------
	//<dd>Corresponds to the 'bottomRadius' field.
	//
	// [default] 1.0
	//
...
public:
	...
	// <dd>Equals operator.
	//
	vrCone& operator=(const vrCone& v);
	...
	//<doc>------------------------------------------------------------
	// <dd>Set the value of the m_BottomRadius member.
	//
	// [in] bottomradius: The bottomradius value.
	//
	...
	//<doc>------------------------------------------------------------
	// <dd>Return the value of the m_BottomRadius member.
	//
	SFFloat GetBottomRadius(void) const;
...
inline void vrCone::SetBottomRadius(SFFloat bottomradius)
{
	m_BottomRadius = bottomradius;
}

inline void vrCone::SetHeight(SFFloat height)
{
	m_Height = height;
}

inline void vrCone::SetSide(SFBool side)
{
	m_Side = side;
}

inline void vrCone::SetBottom(SFBool bottom)
{
	m_Bottom = bottom;
}

inline SFFloat vrCone::GetBottomRadius(void) const
{
	return m_BottomRadius;
}

inline SFFloat vrCone::GetHeight(void) const
{
	return m_Height;
}

inline SFBool vrCone::GetSide(void) const
{
	return m_Side;
}

inline SFBool vrCone::GetBottom(void) const
{
	return m_Bottom;
}

inline void vrCone::Traverse(vrTraverser *t) const
{
	t->Traverse(this);
}
#endif
