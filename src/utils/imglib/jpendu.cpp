                                      ...
                                      JpegEncoderCoefficientBlock &output)
{
  ...
  for (unsigned int row = 0 ; row < JpegSampleWidth ; ++ row)
  {
    ...
    if (i0 >= 0.0)
      output [row][0] = (short)(i0 + 0.5);
    else
      output [row][0] = (short)(i0 - 0.5);
    if (i1 >= 0.0)
      output [row][1] = (short)(i1 + 0.5);
    else
      output [row][1] = (short)(i1 - 0.5);
    if (i2 >= 0.0)
      output [row][2] = (short)(i2 + 0.5);
    else
      output [row][2] = (short)(i2 - 0.5);
    if (i3 >= 0.0)
      output [row][3] = (short)(i3 + 0.5);
    else
      output [row][3] = (short)(i3 - 0.5);
    if (i4 >= 0.0)
      output [row][4] = (short)(i4 + 0.5);
    else
      output [row][4] = (short)(i4 - 0.5);
    if (i5 >= 0.0)
      output [row][5] = (short)(i5 + 0.5);
    else
      output [row][5] = (short)(i5 - 0.5);
    if (i6 >= 0.0)
      output [row][6] = (short)(i6 + 0.5);
    else
      output [row][6] = (short)(i6 - 0.5);
    if (i7 >= 0.0)
      output [row][7] = (short)(i7 + 0.5);
    else
      output [row][7] = (short)(i7 - 0.5);
  }
