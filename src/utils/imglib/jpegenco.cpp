...
//
void JpegEncoder::WriteImage (outputStream &strm, BitmapImage &image)
{
  bit_count = 0 ;
  current_image = &image ;
...
//
void JpegEncoder::PrintComment (char *str)
{
//  unsigned length = sizeof (UBYTE2) + str.length () + 1 ;
  unsigned length = sizeof (UBYTE2) + strlen(str) + 1 ;
  OutputMarker (COM) ;
  OutputWord (length) ;
